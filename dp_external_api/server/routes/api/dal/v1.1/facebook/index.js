...
router.get('/createCustomAudience', (req, res) => {
    ...
    if (!errorMessage) {
        ...
        else if (!(business_id.toUpperCase() in FACEBOOK_BUSINESS_ACCESS_TOKEN_V3_3))
...
router.delete('/clearCustomAudience', (req, res) => {
    ...
    if (!errorMessage) {
         if (!(business_id.toUpperCase() in FACEBOOK_BUSINESS_ACCESS_TOKEN_V3_3))
                errorMessage = 'Business ID was not predefined';
    }
