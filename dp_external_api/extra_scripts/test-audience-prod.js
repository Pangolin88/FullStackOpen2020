...
const BACKENED_URL = 'http://localhost:5000';
const DAL_CALLBACK = 'http://localhost:5000/facebook/dalCallback';
...
const CREATOR = 'thanhtn2';
const BUSINESS_ID = 'pg2';
const IDENTITY_TYPE = 'device_id';
const FB_TYPE = 'fb_audience_list';
const FB_AD_ACCOUNT_ID = '625216534505018';
